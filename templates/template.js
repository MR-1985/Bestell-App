    ...
    return `
                ...
                <div id = "sr-calculating${i}" class=" mt10">
                        ...
                        <div class="view-order">
                            <div id="-button" onclick='basketRemove(${i})' class="btn mr10">-</div>
                            <div id="count-${i}" >
                                
                            </div>
                            <div id="+-button" onclick='basketAdd(${i})' class="btn ml10 mr10">+</div>
                            <div id="price-${i}" class="mr7">
                                ${basketMenu.price.toFixed(2)+" €"}
                            </div>
                            <div id="trash" onclick='deleteItem(${i})' class="mr10"><img src="./assets/icons/trash-bin.PNG" alt="Papierkorb"></div>
                        </div>
                    </div>
    `
};

function addCountTemp(count) {
return `    
                ${count}
    `
};

function removeCountTemp(count) {
return `    
                ${count}
`
}